...
public class BookServiceImpl implements BookService {
    ...
    @Override
    public List<Book> findNotReleasedIn(int releaseDate) {
        LocalDate before = LocalDate.of(releaseDate, 1, 1);
        LocalDate after = LocalDate.of(releaseDate, 12, 31);
    ...
    @Override
    public List<String> findAllBooksByGivenChars(String chars) {
        return this.bookRepository.findByTitleContaining(chars)
                .stream()
                .map(Book::getTitle)
                .collect(Collectors.toList());
    }
    ...
    @Override
    public List<Book> findAllTitlesWhichLastNameStartsBy(String chars) {
        return this.bookRepository.findByAuthorLastNameStartingWith(chars);
    }

    @Override
    public int findBooksCountWithLongerTitleThanGiven(int length) {
        return this.bookRepository.countBooksWithLongerTitleThanGiven(length);
    }

    @Override
    public BookSummary getInfoForBookByTitle(String title) {
